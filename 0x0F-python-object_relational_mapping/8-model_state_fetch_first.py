#!/usr/bin/python3
"""
task 8: python boilerplate script to query database using sqlalchemy orm
this task select first record from a table
"""
import sys
...
if __name__ == "__main__":
    ...
    query_result = session.query(State).order_by(asc(State.id)).first()
